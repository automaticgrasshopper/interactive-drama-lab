...
class EpisodePipelineV045Test(unittest.TestCase):
    ...
    def test_manifest_and_skill_are_v045(self):
        ...
        self.assertEqual(manifest["skill_version"], "v0.1.45")
    ...
    def test_story_rhythm_platform_is_aligned_to_v045(self):
        platform = (ROOT / "h5" / "影视互动游戏故事节奏验证.html").read_text(encoding="utf-8")
        self.assertIn("episode-generator v0.1.45 分集规划师", platform)
        self.assertIn("0.1.45-workbench", platform)
    ...
    def test_backend_v045_uses_one_compact_postwriting_quality_gate(self):
